                ...
                <form onSubmit={handleCreateUser} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-zinc-700 rounded-md px-3 py-2 text-white focus:outline-none focus:border-blue-500"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-zinc-400 mb-1">Rol Inicial</label>
                    <select
                      value={newUserRole}
            ...
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden">
                  ...
                  <div key={user.id} className="p-4 space-y-3">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="p-2 rounded hover:bg-red-900/20 text-zinc-500 hover:text-red-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <div className="flex items-center justify-between gap-4 pt-2">
                      ...
                      <select
                        ...
                        className={`bg-black border border-zinc-700 text-xs rounded px-3 py-2 focus:outline-none focus:border-blue-500 transition-colors cursor-pointer w-32 ${
                          user.role === 'admin' ? 'text-blue-400 border-blue-900/50 bg-blue-950/20' :
                          user.role === 'editor' ? 'text-green-400 border-green-900/50 bg-green-950/20' :
                          'text-zinc-300'
                        }`}
                        disabled={user.id === currentUser?.id}
                      >
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-zinc-950 border-b border-zinc-800 text-zinc-400 text-sm uppercase">
                      ...
                      <tr key={user.id} className="hover:bg-zinc-800/50 transition-colors">
                        ...
                        <td className="p-4">
                          <select
                            value={user.role || 'subscriber'}
                            onChange={(e) => handleUpdateRole(user.id, e.target.value)}
                            className={`bg-black border border-zinc-700 text-sm rounded px-3 py-1.5 focus:outline-none focus:border-blue-500 transition-colors cursor-pointer ${
                              user.role === 'admin' ? 'text-blue-400 border-blue-900/50 bg-blue-950/20' :
                              user.role === 'editor' ? 'text-green-400 border-green-900/50 bg-green-950/20' :
                              'text-zinc-300'
                            }`}
